//Este código esta modificado por Isaac cualquier queja 
//contactarse con el por whatsapp o en presencial...... gracias 
                                    ...
                                    Serial.println(" i45");
                                       ...
                                       /* if ((RGB_sensorR1<=RedMaxD && RGB_sensorR1>=RedMinD  )||
                                             ...
                                             (RGB_sensorB2<=BlueMaxI && RGB_sensorB2>=BlueMaxI)){
                                              izquierda_45();
                                              delay(1500);
                                              Serial.println("vuelta con dos verdes");
                                           }*/
                                            if (RGB_sensorR1<=RedMaxD && RGB_sensorR1>=RedMinD && RGB_sensorG1<=GreenMaxD && RGB_sensorG1>=GreenMinD &&
                                                  RGB_sensorB1<=BlueMaxD && RGB_sensorB1>=BlueMaxD && RGB_sensorR2<=RedMaxI && RGB_sensorR2>=RedMinI && 
                                                  RGB_sensorB2<=BlueMaxI && RGB_sensorB2>=BlueMaxI)  {
                                                  derecha_45();
                                                  delay(500);
                                                  Serial.println("Vuelta a 180° ");
                                            }else{
                                              Serial.println("noooo");
                                            }
                                            
                                                 //vuelta con un verde a la derecha
                                                  if (RGB_sensorR1<=RedMaxD && RGB_sensorR1>=RedMinD  &&
                                                       RGB_sensorG1<=GreenMaxD && RGB_sensorG1>=GreenMinD &&
                                                       RGB_sensorB1<=BlueMaxD && RGB_sensorB1>=BlueMaxD){
                                                       derecha_rgb();
                                                       ...
                                                       Serial.println("Stop derecho");
                                                          ...
                                                          //vuelta a la izquierda con 1 verde
